document.addEventListener('DOMContentLoaded', () => {
    ...
    function updateProductDetailsUI() {
        ...
        // Placeholder handling if image is missing
        detailImg.src = currentScannedProduct.image ? `/static/${currentScannedProduct.image}` : 'data:image/gif;base64,R0lGODlhAQABAAD/ACwAAAAAAQABAAACADs=';
        ...
        cart.forEach((item, index) => {
            ...
            itemDiv.innerHTML = `
                <div class="cart-item-info">
                    <img src="${item.image ? '/static/'+item.image : 'https://via.placeholder.com/30'}" class="cart-item-img">
